...
export default function SongCard({ song }: SongCardProps) {
  ...
  return (
    <>
      <div
        className="card relative overflow-hidden rounded-2xl border border-teal-500/20 bg-gradient-to-br from-slate-950 via-gray-900 to-slate-950 p-5 md:p-7 flex flex-col gap-3 md:gap-4 cursor-pointer shadow-lg shadow-black/40 hover:shadow-teal-600/30 ring-1 ring-black/40 hover:ring-teal-400/60 transition"
